  ...
  <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
    ...
    @endphp
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $reversedImages[0])}}' }">
          ...
          <div class="lg:pl-20">
            <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
              ...
              <p class="max-w-md text-gray-700 dark:text-gray-400">
                ...
                <!--
                    The markdown method is used to convert the description
                    of the product from markdown syntax to HTML.
                    This is done to allow the product description to be
                    formatted with bold text, italic text, lists, etc.
                -->
              </p>
            </div>
            <div class="w-32 mb-8 ">
