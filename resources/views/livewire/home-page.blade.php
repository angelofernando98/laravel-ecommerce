...
<div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Angel Shop</span></h1>
...
<section class="py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      Discover the best brands that our customers love! At Angel Shop, we bring you a curated selection of top brands known for their quality, style, and innovation. Whether you’re looking for the latest trends or timeless classics, our popular brands have something for everyone. <br><br>Explore our collection and find your new favorites today!
      </p>
    </div>
  </div>
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            ...
            <p class="mb-12 text-base text-center text-gray-500">
            Explore our diverse range of categories to find exactly what you’re looking for. At Angel Shop, we offer a wide variety of products to suit every need and preference. Whether you’re shopping for yourself or looking for the perfect gift, our categories make it easy to discover new and exciting items. <br><br> Dive in and start browsing!
            </p>
            </div>
        </div>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          @foreach ($categories as $category)
            <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" wire::key="{{ $brand->id }}">
    ...
    <section class="py-14 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            ...
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                Our customers love shopping at Angel Shop, and we’re proud to share their experiences with you. Read what they have to say about our products and services. Your feedback helps us continue to provide the best shopping experience possible!
                </p>
            </div>
            </div>
